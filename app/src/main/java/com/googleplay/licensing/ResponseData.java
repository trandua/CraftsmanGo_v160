...
public class ResponseData {
    ...
    public static ResponseData parse(String str) {
        ...
        String[] split = TextUtils.split(str, Pattern.quote(AuthenticationConstants.Broker.CALLER_CACHEKEY_PREFIX));
        if (split.length >= 6) {
    ...
    public String toString() {
        return TextUtils.join(AuthenticationConstants.Broker.CALLER_CACHEKEY_PREFIX, new Object[]{Integer.valueOf(this.responseCode), Integer.valueOf(this.nonce), this.packageName, this.versionCode, this.userId, Long.valueOf(this.timestamp)});
    }
}
