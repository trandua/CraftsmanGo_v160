...
public class Base64 {
    ...
    private static int decode4to3(byte[] source, int srcOffset, byte[] destination, int destOffset, byte[] decodabet) {
        int i = srcOffset + 2;
        if (source[i] == 61) {
            destination[destOffset] = (byte) ((((decodabet[source[srcOffset + 1]] << 24) >>> 12) | ((decodabet[source[srcOffset]] << 24) >>> 6)) >>> 16);
            return 1;
        }
        int i2 = srcOffset + 3;
        if (source[i2] == 61) {
            int i3 = (decodabet[source[srcOffset + 1]] << 24) >>> 12;
            int i4 = ((decodabet[source[i]] << 24) >>> 18) | i3 | ((decodabet[source[srcOffset]] << 24) >>> 6);
            destination[destOffset] = (byte) (i4 >>> 16);
            destination[destOffset + 1] = (byte) (i4 >>> 8);
            return 2;
        }
        int i5 = (decodabet[source[srcOffset + 1]] << 24) >>> 12;
        int i6 = ((decodabet[source[i2]] << 24) >>> 24) | i5 | ((decodabet[source[srcOffset]] << 24) >>> 6) | ((decodabet[source[i]] << 24) >>> 18);
        destination[destOffset] = (byte) (i6 >> 16);
        destination[destOffset + 1] = (byte) (i6 >> 8);
        destination[destOffset + 2] = (byte) i6;
        return 3;
    }
    ...
    public static byte[] encode(byte[] bArr, int i, int i2, byte[] bArr2, int i3) {
        ...
        if (i5 < i2) {
            encode3to4(bArr, i + i5, i2 - i5, bArr3, i6, bArr2);
            if (i7 + 4 == i3) {
                bArr3[i6 + 4] = (byte) 10;
            }
        }
