...
public abstract class ScreenLayout extends FrameLayout {
    ...
    public ScreenLayout(Context context, AttributeSet attributeSet) {
        ...
        this.screenPercent = obtainStyledAttributes.hasValue(XLERValueHelper.getStyleableRValue("ScreenLayout_screenDIPs")) ? (int) ((obtainStyledAttributes.getDimensionPixelSize(XLERValueHelper.getStyleableRValue("ScreenLayout_screenDIPs"), SystemUtil.getScreenWidth()) / SystemUtil.getScreenWidth()) * 100.0f) : obtainStyledAttributes.getInt(XLERValueHelper.getStyleableRValue("ScreenLayout_screenPercent"), -2);
