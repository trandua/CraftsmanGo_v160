...
public class CreationErrorFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        return layoutInflater.inflate(C5528R.layout.xbid_fragment_error_creation, viewGroup, false);
    }

    @Override // android.app.Fragment
    public void onViewCreated(View view, Bundle bundle) {
        super.onViewCreated(view, bundle);
//        UiUtil.ensureClickableSpanOnUnderlineSpan((TextView) view.findViewById(R.dimen.m3_comp_navigation_bar_container_height), C5528R.string.xbid_creation_error_android, new ClickableSpan() { // from class: com.microsoft.xbox.idp.ui.CreationErrorFragment.1
