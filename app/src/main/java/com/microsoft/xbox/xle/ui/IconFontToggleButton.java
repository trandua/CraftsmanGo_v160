...
public class IconFontToggleButton extends LinearLayout implements Checkable {
    ...
    private void applyCustomTypeface(Context context, String str) {
        TextView textView;
        if (str == null || (textView = this.labelTextView) == null) {
            return;
        }
        textView.setTypeface(FontManager.Instance().getTypeface(getContext(), str));
    }

    private void initViews(Context context, AttributeSet attributeSet) {
        ((LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.iconfont_toggle_btn_view, (ViewGroup) this, true);
        ...
        float dimensionPixelSize = obtainStyledAttributes2.getDimensionPixelSize(XLERValueHelper.getStyleableRValue("IconFontToggleButton_icon_size"), -1);
    ...
    public void setChecked(boolean z) {
        ...
        if (textView != null) {
            ...
            this.labelTextView.setVisibility(View.VISIBLE);
        }
