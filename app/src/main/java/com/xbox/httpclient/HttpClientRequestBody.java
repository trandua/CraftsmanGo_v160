...
public final class HttpClientRequestBody extends RequestBody {
    ...
    private final class NativeInputStream extends InputStream {
        ...
        final HttpClientRequestBody this$0;

        private native int nativeRead(long j, long j2, byte[] bArr, long j3, long j4) throws IOException;

        public NativeInputStream(HttpClientRequestBody httpClientRequestBody, long j) {
            this.this$0 = httpClientRequestBody;
            this.callHandle = j;
        }
    ...
    public void writeTo(BufferedSink bufferedSink) throws IOException {
        bufferedSink.writeAll(Okio.source(new NativeInputStream(this, this.callHandle)));
    }
}
